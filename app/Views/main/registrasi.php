...
<div class="container">
	<div class="row">
		<div class="col">
			<div class="info">
				<center>
					<h2><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Registrasi ILKOMP HACKATHON 2021</h2>
				</center>
				<hr style="border: 1px grey solid;">
			</div><br>

			<form action="<?= base_url('hackathon/save'); ?>" method="POST">
				<?= csrf_field(); ?>
				<div class="registry">
					<div class="avatar">
					...
					<div class="button-class">
						...
						<button onclick=" window.location.href='<?= base_url('registrasi'); ?>" type="submit" name="cancel" class="button btn btn-danger">
